...
urlpatterns = [
   ...
   #sendsms
   path("v2/sms/create/send_single_msg", SendSingMsgCreate.as_view(), name="send-one-msg"),
   path("v2/sms/create/send_group_sms", SendGroupSms.as_view(), name="send-group-sms"),
   path("v2/sms/create/send_flash_sms",  SendFlashSms.as_view(), name="send-flash-sms"),

   #config
   path("v2/sms/config/add_config", SendSingMsgCreate.as_view(), name="send-one-msg"),
