from .views import sendmessage, translateMessages,  nuobj_api, CreateUser, ListUser, VerifyAccount, GroupList, GroupDetail #GroupUniqueList, GroupUniqueDelete,  sendmessage_infobip, get_recipients_ibp
...
urlpatterns = [
   ...
   #  path('', schema_view.with_ui('swagger', cache_timeout=0), name='schema-swagger-ui'),
    ...
    path("v1/sms/grp-recipient/<str:pk>", GroupDetail.as_view(), name="update-group"),
