# Generated by Django 3.0.7 on 2020-07-23 20:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verified_no', phonenumber_field.modelfields.PhoneNumberField(max_length=128, region=None)),
                ('service_name', models.CharField(choices=[('INFOBIP', 'IF'), ('TWILIO', 'TW'), ('TELESIGN', 'TS'), ('MESSAGEBIRD', 'MB'), ('GATEWAYAPI', 'GA')], max_length=50)),
                ('senderID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='details', to='smsApp.Sender')),
            ],
        ),
        migrations.CreateModel(
            name='Recipient',
            fields=[
                ...
                ('dateCreated', models.DateTimeField(default=django.utils.timezone.now)),
                ('senderID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recipients', to='smsApp.Sender')),
            ],
        ),
        migrations.CreateModel(
            name='Message',
            fields=[
                ...
                ('service_type', models.CharField(choices=[('IF', 'IF'), ('TW', 'TW'), ('TS', 'TS'), ('MB', 'MB'), ('GA', 'GA')], max_length=2)),
                ...
                ('senderID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='smsApp.Sender')),
            ],
        ),
        migrations.CreateModel(
            name='GroupNumbers',
        ...
        migrations.AddField(
            model_name='group',
            name='senderID',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='group', to='smsApp.Sender'),
        ),
    ]
