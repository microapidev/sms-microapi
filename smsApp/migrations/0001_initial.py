# Generated by Django 3.0.7 on 2020-06-30 11:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.CharField(default='twillo', max_length=50)),
        ...
        migrations.CreateModel(
            name='Group',
            fields=[
                ('groupName', models.CharField(default='grp1', max_length=80)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('recipient', models.CharField(blank=True, max_length=15, validators=[django.core.validators.RegexValidator(message="Phone number must be entered in the format: '+999999999'. Up to 15 digits allowed.", regex='^\\+?1?\\d{9,15}$')])),
                ('dateCreated', models.DateTimeField(default=django.utils.timezone.now)),
                ('user', models.ForeignKey(default=2, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='owner')),
            ],
        ),
        migrations.CreateModel(
            name='Message',
